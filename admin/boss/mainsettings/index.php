...
// Area exclusiva del jefe. Va AQUI, antes del POST: este handler reescribe el
// .env entero (nombre del negocio, idioma, moneda, aforo...), y el $is_boss que
// se cargaba mas abajo llegaba demasiado tarde para impedirlo.
